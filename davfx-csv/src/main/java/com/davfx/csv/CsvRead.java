...
import com.davfx.csv.impl.CsvKeyedReaderImpl;
import com.davfx.csv.impl.CsvReaderImpl;
...
public final class CsvRead {
	...
	private Charset charset = Charset.forName(CONFIG.getString("davfx.csv.charset"));
	private char delimiter = ConfigUtils.getChar(CONFIG, "davfx.csv.delimiter");
	private char quote = ConfigUtils.getChar(CONFIG, "davfx.csv.quote");
	private boolean ignoreEmptyLines = CONFIG.getBoolean("davfx.csv.ignoreEmptyLines");
